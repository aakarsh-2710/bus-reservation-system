package com.mcs.booking.aspect;
...
public class LoggingAspect {
	 ...
	 * 
	 */
	@Before("execution(* com.mcs.booking.*.*.*(..)) ")
	...
	@After("execution(* com.mcs.booking.*.*.*(..)) ")
	...
	@AfterThrowing(pointcut = "execution(* com.mcs.booking.*.*.*(..))", throwing = "ex")
	...
	@AfterReturning(pointcut = "execution(* com.mcs.booking.*.*.*(..))", returning = "returnValue")
