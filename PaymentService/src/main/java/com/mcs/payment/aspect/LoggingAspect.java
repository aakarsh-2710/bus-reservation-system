package com.mcs.payment.aspect;
...
public class LoggingAspect {
	 ...
	 * 
	 */
	@Before("execution(* com.mcs.payment.*.*.*(..)) ")
	...
	@After("execution(* com.mcs.payment.*.*.*(..)) ")
	...
	@AfterThrowing(pointcut = "execution(* com.mcs.payment.*.*.*(..))", throwing = "ex")
	...
	@AfterReturning(pointcut = "execution(* com.mcs.payment.*.*.*(..))", returning = "returnValue")
